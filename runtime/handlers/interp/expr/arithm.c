	...
	switch (a.val.type)
	{
		case GWBCT_INTEGER:
		{
			switch (b.val.type)
			{
				case GWBCT_INTEGER:	
					result.val.type = GWBCT_SINGLE;
					result.val.single_val = powf(a.val.int_val, b.val.int_val);
					break;
				case GWBCT_SINGLE:
					result.val.type = GWBCT_SINGLE;
					result.val.single_val = powf(a.val.int_val, b.val.single_val);
					break;
				case GWBCT_DOUBLE:
					result.val.type = GWBCT_DOUBLE;
					result.val.double_val = pow(a.val.int_val, b.val.double_val);
					break;
			}
			break;
		}
		case GWBCT_SINGLE:
		{
			switch (b.val.type)
			{
				case GWBCT_INTEGER:
					result.val.type = GWBCT_SINGLE;
					result.val.single_val = powf(a.val.single_val, b.val.int_val);
					break;
				case GWBCT_SINGLE:
					result.val.type = GWBCT_SINGLE;
					result.val.single_val = powf(a.val.single_val, b.val.single_val);
					break;
				case GWBCT_DOUBLE:
					result.val.type = GWBCT_DOUBLE;
					result.val.double_val = pow(a.val.single_val, b.val.double_val);
					break;
			}
			break;		
		}
		case GWBCT_DOUBLE:
		{
			switch (b.val.type)
			{
				case GWBCT_INTEGER:
					result.val.type = GWBCT_DOUBLE;
					result.val.double_val = pow(a.val.double_val, b.val.int_val);
					break;
				case GWBCT_SINGLE:
					result.val.type = GWBCT_DOUBLE;
					result.val.double_val = pow(a.val.double_val, b.val.single_val);
					break;
				case GWBCT_DOUBLE:
					result.val.type = GWBCT_DOUBLE;
					result.val.double_val = pow(a.val.double_val, b.val.double_val);
					break;
			}
			break;
		}
